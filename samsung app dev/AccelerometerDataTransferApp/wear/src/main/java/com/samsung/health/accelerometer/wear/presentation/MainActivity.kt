...
import com.samsung.health.accelerometer.wear.R
import com.samsung.health.accelerometer.wear.presentation.ui.MainScreen
import com.samsung.health.accelerometer.wear.presentation.ui.Permission
            ...
            LaunchedEffect(Unit) {
                viewModel
                    ...
                    .collect { message ->
                        Toast.makeText(
                            applicationContext,
                            if (message) "Data sent successfully" else "Failed to send data",
                            Toast.LENGTH_SHORT,
                        ).show()
                    }
            }
